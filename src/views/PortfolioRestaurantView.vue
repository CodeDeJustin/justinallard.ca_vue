...
<AppPolygone />
      ...
      <section class="section">
        <h2>Site web pour une pizzeria</h2>
        <div class="col-contenu-img">
          <a href="https://justinallard.pythonanywhere.com/" class="clickable-image" target="_blank">
            <img src="/media/project1.jpg" class="profile-pic" alt="Pizza Mama" />
          </a>
        </div>
        <div class="col-contenu float-right">
          <div class="texte-avec-ligne-verticale">
            <p>
              J'aimerais vous dire que j'ai créé ce site Web pour l'une des plus grandes pizzerias de la ville,
              mais... Non!
            </p>

            <p>
              J'ai créé ce projet lors d'une introduction à Python et Django. J'ai décidé de créer un site web
              pour une pizzeria fictive. J'ai utilisé le framework Django pour la gestion du site web et pour
              l'interface utilisateur.
            </p>

            <p>
              J'ai utilisé le langage de programmation Python pour la gestion des données et la création de
              fonctionnalités back-end, telles que le système de gestion de menu pour la pizzeria. L'objectif était de simuler
              un environnement réel de gestion d'une pizzeria, permettant à l'utilisateur d'ajouter, de modifier et de
              supprimer des pizzas du menu.
            </p>

            <p>
              La partie front-end a été réalisée avec HTML, CSS et un peu de JavaScript. J'ai créé une
              interface utilisateur simple mais élégante, où les clients peuvent visualiser le menu et les détails des pizzas.
            </p>

            <p>
              Pour la mise en ligne du projet, j'ai choisi la plateforme PythonAnywhere. Cela m'a permis de
              déployer facilement mon application Django et de la rendre accessible sur Internet.
            </p>

            <p>
              Pour conclure, ce projet, bien qu'imaginaire, illustre mes efforts et mes apprentissages en tant
              que développeur. Il reflète ma capacité à concevoir et à réaliser une application web fonctionnelle, en intégrant
              des technologies comme Django et Python, ainsi que des compétences en front-end.
            </p>

            <p>
              Technologies utilisées : Visual Studio Code, HTML, CSS, Javascript, Django, Python, Python
              Anywhere
            </p>

            <a href="https://justinallard.pythonanywhere.com/" class="clickable-link" target="_top">Consulter le projet</a>
          </div>
        </div>
      </section>
    </main>
