...
<AppPolygone />
      ...
      <section class="section">
        ...
        <div class="col-contenu-img">
          <a href="https://justinallard.ca/" class="clickable-image">
            <img src="/media/project2.jpg" class="profile-pic" alt="Ce site web!" />
          </a>
        </div>
        <div class="col-contenu float-right">
          <div class="texte-avec-ligne-verticale">
            <p>
              Ce site web, initialement pensé comme une simple vitrine pour
              présenter mes projets de portfolio, s'est rapidement mué en
              un terrain de jeu expérimental. Il est devenu le reflet de
              ma curiosité technique, un laboratoire où j'explore les tendances
              actuelles et émergentes en développement web.
            </p>

            <p>
              La construction de ce site m'a permis de me familiariser avec
              des aspects cruciaux du développement web moderne, comme la
              gestion efficace de la zone DNS, l'acquisition et le
              renouvellement de noms de domaine, ainsi que la mise en œuvre
              de certificats SSL pour garantir une connexion sécurisée.
            </p>

            <p>
              J'ai opté pour une construction épurée avec HTML, CSS et JavaScript "vanille". 
              Ce choix a été guidé par la volonté d'assurer une performance maximale et une compatibilité 
              universelle. Ce site est un projet en perpétuelle évolution.
            </p>

            <p>
              Technologies utilisées : Visual Studio Code, HTML, CSS, Javascript, Filezilla (Bientôt, ce site sera transformé en React Typescript).
            </p>

            <a href="https://justinallard.ca/" class="clickable-link" target="_top">Consulter le projet</a>
          </div>
        </div>
      </section>
    </main>
