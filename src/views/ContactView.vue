...
<AppPolygone />
      ...
      <section class="section contact-section">
        ...
        <div class="col-contenu-img">
          <img :src="require('@/assets/media/profile3.jpg')" class="profile-pic" />
        </div>
        <div class="col-contenu float-right">
          <div class="texte-avec-ligne-verticale">
            <div>
              <!-- Courriel -->
              <a class="contact-method clickable-link" href="mailto:justin@justinallard.ca">
                <i class="fas fa-envelope contact-icon"></i>
                <span class="contact-text">Courriel</span>
              </a>

              <!-- Messenger -->
              <a class="contact-method clickable-link" href="https://m.me/justin.allard2/" target="_blank">
                <i class="fab fa-facebook-messenger contact-icon"></i>
                <span class="contact-text">Messenger</span>
              </a>

              <!-- LinkedIn -->
              <a class="contact-method clickable-link" href="https://www.linkedin.com/in/justin-allard-prog" target="_blank">
                <i class="fab fa-linkedin contact-icon"></i>
                <span class="contact-text">LinkedIn</span>
              </a>

              <!-- Medium -->
              <a class="contact-method clickable-link" href="https://medium.com/@justinallard" target="_blank">
                <i class="fab fa-medium contact-icon"></i>
                <span class="contact-text">Medium</span>
              </a>

              <!-- GitHub -->
              <a class="contact-method clickable-link" href="https://github.com/CodeDeJustin" target="_blank">
                <i class="fab fa-github contact-icon"></i>
                <span class="contact-text">GitHub</span>
              </a>

              <!-- Discord -->
              <div class="contact-method clickable-link">
                <i class="fab fa-discord contact-icon"></i>
                <span class="contact-text">justin.allard</span>
              </div>

              <!-- Grabcad -->
              <a class="contact-method clickable-link" href="https://grabcad.com/justin.allard-3" target="_blank">
                <i class="fas fa-cubes contact-icon"></i>
                <span class="contact-text">Grabcad</span>
              </a>
            </div>
          </div>
        </div>
...
.transition-enabled .texte-avec-ligne-verticale,
.transition-enabled .texte-avec-ligne-verticale p,
