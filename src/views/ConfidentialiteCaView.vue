      ...
      <section class="section">
        ...
        <div class="texte-avec-ligne-verticale">
          <p><b>Introduction</b><br>
            ...
            il est nécessaire de porter une attention particulière à la
            protection de la vie privée. C’est pourquoi, nous nous engageons
            à respecter la confidentialité des renseignements personnels
            que nous collectons.
          </p>

          <p><b>Collecte des renseignements personnels</b></p>
          <p>
          ...
          <p><b>Cookies et technologies similaires</b></p>
          <p>
            Nous utilisons des cookies pour améliorer votre expérience sur
            notre site, pour comprendre comment il est utilisé et pour
            personnaliser le contenu ainsi que la publicité. Les cookies
            sont des petits fichiers textes qui peuvent être utilisés par
            les sites web pour rendre l'expérience utilisateur plus efficace.
            La loi stipule que nous pouvons stocker des cookies sur votre
            appareil s'ils sont strictement nécessaires au fonctionnement de ce
            site. Pour tous les autres types de cookies, nous avons besoin de
            votre permission.
          </p>

          <p><b>Formulaires et interactivité:</b></p>
          <ul>
            <li>Statistiques</li>
            <li>Contact</li>
          </ul>

          <p>Vos renseignements sont également collectés par l’interactivité pouvant s’établir entre vous et notre site Web:</p>
          <ul>
            <li>Commentaires</li>
          ...
          <p>
            ...
            s’entend comme étant la possibilité offerte aux internautes de
            refuser que leurs renseignements personnels soient utilisés à
            certaines fins. Le droit de retrait s’entend comme la possibilité
            offerte aux internautes de demander à ce que leurs renseignements
            personnels ne figurent plus dans une liste de diffusion.
          </p>

          <p><b>Pour exercer ces droits, vous pouvez communiquer avec nous :</b></p>
          <p>Courriel : confidentialite@justinallard.ca</p>
          <p>Section du site web : 
            <router-link to="/contact" class="footer-link clickable-link">https://www.justinallard.ca/contact</router-link>
          </p>
          ...
          <router-link to="/confidentialite-eu" class="clickable-link">
            <h3>Cliquez ici pour lire la politique de confidentialité de l'Union Européenne</h3>
          </router-link>
        </div>
      </section>
    </main>
