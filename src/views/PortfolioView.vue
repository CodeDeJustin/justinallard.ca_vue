      ...
      <section class="section">
        ...
        <div class="portfolio-container">
          <div class="portfolio-item">
            <router-link to="/portfolio-restaurant">
              <img class="portfolio-img" src="/media/project1.jpg" alt="Projet 1" />
            </router-link>
            <p>
              <router-link to="/portfolio-restaurant" class="clickable-link">Site web pour un restaurant</router-link>
            </p>
          </div>

          <div class="portfolio-item float-right">
            <router-link to="/portfolio-ce-site-web">
              <img class="portfolio-img" src="/media/project2.jpg" alt="Projet 2" />
            </router-link>
            <p>
              <router-link to="/portfolio-ce-site-web" class="clickable-link">Ce site web!</router-link>
            </p>
          </div>
        </div>

        <h2>D'autres projets sont en cours!</h2>
      </section>
    </main>
